...
public static class GuardTester {
	...
	public static class NotNullWithClass {
		[Fact]
	...
	public static class NotNullWithStruct {
		[Fact]
	...
	public static class NullOrEmptyWithArray {
		[Fact]
		public static void returns_the_argument() => Guard.NotNullOrEmpty(TestValues.TestArray, Arg).ShouldBe(TestValues.TestArray);

		[Fact]
		public static void should_not_throw_on_instance() => Should.NotThrow(() => Guard.NotNullOrEmpty(TestValues.TestArray, Arg));

		[Fact]
		public static void should_throw_on_empty() => Should.Throw<ArgumentException>(() => Guard.NotNullOrEmpty(TestValues.EmptyArray, Arg));

		[Fact]
		public static void should_throw_on_null() => Should.Throw<ArgumentNullException>(() => Guard.NotNullOrEmpty(TestValues.NullArray, Arg));
	}

	public static class NullOrEmptyWithCollection {
		[Fact]
